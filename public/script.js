const items = [
  ...
  {name:'청년월세 지원',category:'청년·주거',benefit:'최대 480만 원 (월 20만 원 × 24개월)',summary:'대상 연령과 소득 기준, 다음 모집 일정을 글에서 확인하세요.',wp:2186,terms:'청년 월세 주거'},
  {name:'청년내일저축계좌',category:'청년·주거',benefit:'최대 1,440만 원 (월 10만 원 × 3년)',summary:'근로·소득 요건과 다음 모집 일정을 글에서 확인하세요.',wp:2188,terms:'청년 적금 자산 저축'},
